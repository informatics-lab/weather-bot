...
exports.coat = new variableThresholdIntentBuilder("weather.accessory", "coat", ["jacket", "anorak", "mac", "cagoule"], [{variable:"feels_like_temperature", comparison:"LT", optimal:7, max:12}, {variable:"precipitation_probability", comparison:"GT", min:20, optimal:50}]);
